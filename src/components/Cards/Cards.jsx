...
<Grid item component={Card} xs={12} md={2} className="card confirmed">
    <CardContent >
        ...
        <Typography className="fontType newCasesFont" color="textSecondary">{props.data.dailyConfirmed}</Typography>
...
<Grid item component={Card} xs={12} md={2} className="card recovered">
    <CardContent>
        ...
        <Typography className="fontType newCasesFont" color="textSecondary">{props.data.dailyRecovered}</Typography>
...
<Grid item component={Card} xs={12} md={2} className="card deceased">
    <CardContent>
        ...
        <Typography className="fontType newCasesFont" color="textSecondary">{props.data.dailyDeceased}</Typography>
